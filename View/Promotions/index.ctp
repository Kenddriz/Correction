<?php $this->start('gestion'); ?>
	...
	<div class="row">
		...
		<!--Liste-->
		<?php $annee_scolaire_actuelle = array_keys($selects[1])[0] ;?>
		<span class="col">
							...
							<tr>
								<td class="text-center">
									<input type="checkbox" name="selected[]" 
										...
										<?=($annee_scolaire_actuelle === $resultat['Promotion']['des_annee_scolaire']) ? '' : 'disabled'?>
									>
								</td>
								<td class="text-center">
				...
				<table cellpadding="4px" class="table table-sm small">
					...
					<tbody>
						...
						<tr class="bg-light text-dark text-center">
							...
							<td id="annee_scolaire_n"><?php echo $annee_scolaire_actuelle; ?></td>
						</tr>
						<tr>
							<td colspan="2">
